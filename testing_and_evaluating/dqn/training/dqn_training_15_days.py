# python -m testing_and_evaluating.dqn.training.dqn_training_15_days
...
model = DQN(
    ...
    verbose=1,
    tensorboard_log="./logs/15_days_models/dqn/activity_3",
)
...
model.save("models/15_days_models/dqn/dqn_agent_v3")
