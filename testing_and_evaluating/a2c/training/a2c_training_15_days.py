# python -m testing_and_evaluating.a2c.training.a2c_training_15_days
...
model = A2C(
    "MlpPolicy", env_start,
    verbose=1,
    tensorboard_log="./logs/15_days_models/a2c/activity_3",
)
...
model.save("models/15_days_models/a2c/a2c_agent_v3")
