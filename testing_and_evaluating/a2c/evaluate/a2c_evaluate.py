# python -m testing_and_evaluating.a2c.evaluate.a2c_evaluate
...
df = pd.read_csv("synthetic_courses/tests/test_2.csv")["Price"]

env = Monitor(TradingEnvironment(df=df))

model = A2C.load("models/a2c/a2c_agent_v1", env=env)
