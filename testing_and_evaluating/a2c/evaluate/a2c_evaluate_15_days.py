# python -m testing_and_evaluating.a2c.evaluate.a2c_evaluate_15_days
...
df = pd.read_csv("synthetic_courses/tests/test_1.csv")["Price"]

env = Monitor(TradingEnvironment(df=df))

model = A2C.load("models/15_days_models/a2c/a2c_agent_v3", env=env)
